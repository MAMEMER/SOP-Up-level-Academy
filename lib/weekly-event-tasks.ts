...
// และ reset ทุก "วันจัดกิจกรรม" (ราย workDate) ผ่าน weekly-event-store — เกมที่จัดหลายวัน/สัปดาห์
// (เช่น Lorcana พุธ–อาทิตย์) จึงเริ่ม checklist ใหม่ทุกวัน ไม่ค้างข้ามวัน
//
